...
public class CustomMonster2 extends EntityMob {
	
	public CustomMonster2(World worldIn) {
		super(worldIn);
	}
	...
	public static final ResourceLocation LOOT = new ResourceLocation(Main.MODID, "entities/my_monster2");
