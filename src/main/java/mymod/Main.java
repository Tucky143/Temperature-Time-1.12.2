...
public class Main {
    ...
    //************* DECLARE VARIABLES ***************
    public static EvoStone evoStone;
    public static Unbreakable unbreakableB;
    public static BrokenBedrock myBrokenB;
    ...
    public void preInit(FMLPreInitializationEvent event) {
    	...
    	unbreakableB = new Unbreakable();
    	evoStone = new EvoStone();
    	myBrokenB = new BrokenBedrock();
