...
public class CustomMob2 extends EntityMob {
	
	public float moveSpeed;
	public float attackDamage;
	public float health;
	
	public static final ResourceLocation LOOT = new ResourceLocation(Main.MODID, "entities/my_mob2");

	public CustomMob2(World worldIn) {
		super(worldIn);
	}
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(4, new EntityAINearestAttackableTarget(this, EntityOcelot.class, true));
		this.targetTasks.addTask(5, new EntityAINearestAttackableTarget(this, EntitySilverfish.class, true));
		this.targetTasks.addTask(6, new EntityAINearestAttackableTarget(this, EntityWitherSkeleton.class, true));
	}
	...
	static class EntityAIFireballAttack extends EntityAIBase{
		private final CustomMob2 attacker;
		
		public EntityAIFireballAttack(CustomMob2 attacker) {
